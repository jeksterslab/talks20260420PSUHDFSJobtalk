...
\begin{tikzpicture}[
	...
	{packages, containers,\\and reusable templates};
		
	\node[smalltxt, align=center] at ($(right.center)+(0,-2.15)$)
	{open tools, scalable workflows,\\and decision-ready summaries};
		
	% Bottom strip
	\node[strip, minimum width=19.4cm] at (9.2,0.90)
	{\sffamily\fontsize{10.4}{12.0}\selectfont\color{textdark}
		local estimation $\rightarrow$ careful synthesis $\rightarrow$ usable collaboration};
